...
@compute @workgroup_size(4,3) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu3 = (lidx1+(lidx0*10647)+alu0+(gidx1*42588));
  var alu4 = (alu3+-7098);
  var val0 = select(0.0f, data3[alu1], ((lidx0+bitcast<i32>(precast1))<1));
  var alu5 = (alu2<2);
  var val1 = select(0.0f, data3[alu1], alu5);
  var val2 = select(0.0f, data2[alu3], alu5);
  var alu6 = (alu2<4);
  var val3 = select(0.0f, data3[alu1], alu6);
  var val4 = select(0.0f, data4[(alu3+-10647)], (((gidx1+lidx0)<1)!=true));
  var alu7 = (alu5!=true);
  var val5 = select(0.0f, data4[alu4], alu7);
  var val6 = select(0.0f, data4[(alu3+-14196)], (alu6!=true));
  ...
  data0[(alu3+3549)] = ((val8*val0)+val4);
  data0[(alu3+7098)] = ((val2*val1)+val5);
  data0[alu3] = (((val7+val9)*val3)+val6);
}`;
...
const setupNet = async (device, safetensor) => {
    ...
    return async (_input0) => {
        ...
        addComputePass(device, commandEncoder, pipelines[251], layouts[251], infinityBuf, [buf_490, buf_496, buf_43, buf_45, buf_47, buf_497, buf_49], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[252], layouts[252], infinityBuf, [buf_494, buf_490, buf_51, buf_53, buf_55, buf_498, buf_57], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[253], layouts[253], infinityBuf, [buf_492, buf_494, buf_59, buf_61, buf_63, buf_499, buf_65], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[254], layouts[254], infinityBuf, [buf_500, buf_492, buf_67, buf_69, buf_71, buf_501, buf_73], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[255], layouts[255], infinityBuf, [buf_502, buf_492, buf_500, buf_75, buf_77, buf_79, buf_503, buf_81], [13, 13, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[258], layouts[258], infinityBuf, [buf_490, buf_492, buf_502, buf_505], [169, 4, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[260], layouts[260], infinityBuf, [buf_505, buf_492, buf_107, buf_109, buf_111, buf_508, buf_113], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[261], layouts[261], infinityBuf, [buf_502, buf_505, buf_115, buf_117, buf_119, buf_509, buf_121], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[262], layouts[262], infinityBuf, [buf_510, buf_502, buf_123, buf_125, buf_127, buf_511, buf_129], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[263], layouts[263], infinityBuf, [buf_512, buf_502, buf_510, buf_131, buf_133, buf_135, buf_513, buf_137], [13, 13, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[266], layouts[266], infinityBuf, [buf_494, buf_502, buf_512, buf_515], [169, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[267], layouts[267], infinityBuf, [buf_502, buf_494, buf_155, buf_157, buf_159, buf_517, buf_161], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[268], layouts[268], infinityBuf, [buf_515, buf_502, buf_163, buf_165, buf_167, buf_518, buf_169], [13, 13, 2]);
        addComputePass(device, commandEncoder, pipelines[269], layouts[269], infinityBuf, [buf_512, buf_515, buf_171, buf_173, buf_175, buf_519, buf_177], [169, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[270], layouts[270], infinityBuf, [buf_520, buf_512, buf_179, buf_181, buf_183, buf_521, buf_185], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[271], layouts[271], infinityBuf, [buf_522, buf_512, buf_520, buf_187, buf_189, buf_191, buf_523, buf_193], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[272], layouts[272], infinityBuf, [buf_524, buf_512, buf_522], [169, 12, 1]);
        addComputePass(device, commandEncoder, pipelines[273], layouts[273], infinityBuf, [buf_512, buf_524, buf_195, buf_197, buf_199, buf_525, buf_201], [169, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[274], layouts[274], infinityBuf, [buf_522, buf_512, buf_203, buf_205, buf_207, buf_526, buf_209], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[275], layouts[275], infinityBuf, [buf_520, buf_522], [13, 13, 4]);
        addComputePass(device, commandEncoder, pipelines[276], layouts[276], infinityBuf, [buf_527, buf_520], [13, 13, 4]);
        addComputePass(device, commandEncoder, pipelines[277], layouts[277], infinityBuf, [buf_528, buf_527], [13, 13, 4]);
        addComputePass(device, commandEncoder, pipelines[278], layouts[278], infinityBuf, [buf_505, buf_522, buf_520, buf_527, buf_528], [169, 16, 1]);
        addComputePass(device, commandEncoder, pipelines[279], layouts[279], infinityBuf, [buf_512, buf_505, buf_211, buf_213, buf_215, buf_529, buf_217], [169, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[280], layouts[280], infinityBuf, [buf_530, buf_512, buf_502], [13, 13, 12]);
        addComputePass(device, commandEncoder, pipelines[281], layouts[281], infinityBuf, [buf_502, buf_530, buf_219, buf_221, buf_223, buf_531, buf_225], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[282], layouts[282], infinityBuf, [buf_515, buf_502, buf_227, buf_229, buf_231, buf_532, buf_233], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[283], layouts[283], infinityBuf, [buf_510, buf_515, buf_235, buf_237, buf_239, buf_533, buf_241], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[284], layouts[284], infinityBuf, [buf_534, buf_502, buf_510], [169, 6, 1]);
        addComputePass(device, commandEncoder, pipelines[285], layouts[285], infinityBuf, [buf_502, buf_534, buf_243, buf_245, buf_247, buf_535, buf_249], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[286], layouts[286], infinityBuf, [buf_496, buf_502, buf_492], [13, 13, 6]);
        ...
        addComputePass(device, commandEncoder, pipelines[288], layouts[288], infinityBuf, [buf_505, buf_492, buf_259, buf_261, buf_263, buf_537, buf_265], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[289], layouts[289], infinityBuf, [buf_500, buf_505, buf_267, buf_269, buf_271, buf_538, buf_273], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[290], layouts[290], infinityBuf, [buf_530, buf_492, buf_500], [169, 3, 1]);
        addComputePass(device, commandEncoder, pipelines[291], layouts[291], infinityBuf, [buf_492, buf_530, buf_275, buf_277, buf_279, buf_539, buf_281], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[292], layouts[292], infinityBuf, [buf_494, buf_492, buf_283, buf_285, buf_287, buf_540, buf_289], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[293], layouts[293], infinityBuf, [buf_541, buf_492, buf_303, buf_305, buf_307, buf_542, buf_309], [13, 13, 5]);
        addComputePass(device, commandEncoder, pipelines[294], layouts[294], infinityBuf, [buf_510, buf_492, buf_323, buf_325, buf_327, buf_543, buf_329], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[295], layouts[295], infinityBuf, [buf_492, buf_494, buf_291, buf_293, buf_295, buf_544, buf_297], [13, 13, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[297], layouts[297], infinityBuf, [buf_534, buf_510, buf_502], [169, 6, 1]);
        addComputePass(device, commandEncoder, pipelines[298], layouts[298], infinityBuf, [buf_494, buf_492, buf_299, buf_301], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[299], layouts[299], infinityBuf, [buf_541, buf_545, buf_319, buf_321], [169, 5, 1]);
        addComputePass(device, commandEncoder, pipelines[300], layouts[300], infinityBuf, [buf_502, buf_534, buf_331, buf_333, buf_335, buf_547, buf_337], [169, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[301], layouts[301], infinityBuf, [buf_510, buf_502, buf_339, buf_341, buf_343, buf_548, buf_345], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[302], layouts[302], infinityBuf, [buf_515, buf_510, buf_347, buf_349, buf_351, buf_549, buf_353], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[303], layouts[303], infinityBuf, [buf_534, buf_502, buf_515], [169, 6, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[307], layouts[307], infinityBuf, [buf_528, buf_502, buf_403, buf_405, buf_407, buf_554, buf_409], [13, 13, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[310], layouts[310], infinityBuf, [buf_524, buf_528, buf_512], [169, 12, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[313], layouts[313], infinityBuf, [buf_510, buf_524, buf_411, buf_413, buf_415, buf_558, buf_417], [169, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[314], layouts[314], infinityBuf, [buf_528, buf_510, buf_419, buf_421, buf_423, buf_559, buf_425], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[315], layouts[315], infinityBuf, [buf_527, buf_528, buf_427, buf_429, buf_431, buf_560, buf_433], [13, 13, 1]);
        addComputePass(device, commandEncoder, pipelines[316], layouts[316], infinityBuf, [buf_524, buf_510, buf_527], [169, 12, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[324], layouts[324], infinityBuf, [buf_570, buf_494, buf_512, buf_562], [1183, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[325], layouts[325], infinityBuf, [buf_571, buf_541, buf_552, buf_564], [1183, 5, 1]);
        addComputePass(device, commandEncoder, pipelines[326], layouts[326], infinityBuf, [buf_572, buf_494, buf_512, buf_562, buf_570], [1183, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[327], layouts[327], infinityBuf, [buf_573, buf_494, buf_512, buf_562, buf_570, buf_572, buf_483], [1183, 1, 1]);
