...
const setupNet = async (device, safetensor) => {
    ...
    const buf_584 = createEmptyBuf(device, 85176);;
    const buf_585 = createEmptyBuf(device, 14196);;
    const buf_586 = createEmptyBuf(device, 14196);;
    const buf_587 = createEmptyBuf(device, 1200);;
    const buf_588 = createEmptyBuf(device, 7200);;
    ...
    return async (_input0) => {
        ...
        addComputePass(device, commandEncoder, pipelines[337], layouts[337], infinityBuf, [buf_582, buf_573, buf_485, buf_486], [1183, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[338], layouts[338], infinityBuf, [buf_459, buf_485], [4, 2, 2]);
        addComputePass(device, commandEncoder, pipelines[339], layouts[339], infinityBuf, [buf_583, buf_487, buf_485], [1183, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[340], layouts[340], infinityBuf, [buf_584, buf_578, buf_579, buf_580, buf_581, buf_582, buf_485], [1183, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[341], layouts[341], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[342], layouts[342], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[343], layouts[343], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[344], layouts[344], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[345], layouts[345], infinityBuf, [buf_379, buf_459], [8, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[346], layouts[346], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[347], layouts[347], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[348], layouts[348], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[349], layouts[349], infinityBuf, [buf_379, buf_459], [8, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[350], layouts[350], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[351], layouts[351], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[352], layouts[352], infinityBuf, [buf_459, buf_379], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[353], layouts[353], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[354], layouts[354], infinityBuf, [buf_459, buf_379], [8, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[355], layouts[355], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[356], layouts[356], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[357], layouts[357], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[358], layouts[358], infinityBuf, [buf_459, buf_379], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[359], layouts[359], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[360], layouts[360], infinityBuf, [buf_459, buf_379], [2, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[361], layouts[361], infinityBuf, [buf_379, buf_459], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[362], layouts[362], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[363], layouts[363], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[364], layouts[364], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[365], layouts[365], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[366], layouts[366], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[367], layouts[367], infinityBuf, [buf_379, buf_459], [4, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[368], layouts[368], infinityBuf, [buf_459, buf_379], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[369], layouts[369], infinityBuf, [buf_379, buf_459], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[370], layouts[370], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[371], layouts[371], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[372], layouts[372], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[373], layouts[373], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[374], layouts[374], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[375], layouts[375], infinityBuf, [buf_379, buf_459], [8, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[376], layouts[376], infinityBuf, [buf_459, buf_379], [8, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[377], layouts[377], infinityBuf, [buf_379, buf_459], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[378], layouts[378], infinityBuf, [buf_459, buf_379], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[379], layouts[379], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[380], layouts[380], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[381], layouts[381], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[382], layouts[382], infinityBuf, [buf_459, buf_379], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[383], layouts[383], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[384], layouts[384], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[385], layouts[385], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[386], layouts[386], infinityBuf, [buf_459, buf_379], [8, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[387], layouts[387], infinityBuf, [buf_379, buf_459], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[388], layouts[388], infinityBuf, [buf_459, buf_379], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[389], layouts[389], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[390], layouts[390], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[391], layouts[391], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[392], layouts[392], infinityBuf, [buf_459, buf_379], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[393], layouts[393], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[394], layouts[394], infinityBuf, [buf_459, buf_379], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[395], layouts[395], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[396], layouts[396], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[397], layouts[397], infinityBuf, [buf_379, buf_459], [8, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[398], layouts[398], infinityBuf, [buf_459, buf_379], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[399], layouts[399], infinityBuf, [buf_379, buf_459], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[400], layouts[400], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[401], layouts[401], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[402], layouts[402], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[403], layouts[403], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[404], layouts[404], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[405], layouts[405], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[406], layouts[406], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[407], layouts[407], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[408], layouts[408], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[409], layouts[409], infinityBuf, [buf_379, buf_459], [8, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[410], layouts[410], infinityBuf, [buf_459, buf_379], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[411], layouts[411], infinityBuf, [buf_379, buf_459], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[412], layouts[412], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[413], layouts[413], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[414], layouts[414], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[415], layouts[415], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[416], layouts[416], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[417], layouts[417], infinityBuf, [buf_379, buf_459], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[418], layouts[418], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[419], layouts[419], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[420], layouts[420], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[421], layouts[421], infinityBuf, [buf_379, buf_459], [8, 2, 1]);
        addComputePass(device, commandEncoder, pipelines[422], layouts[422], infinityBuf, [buf_459, buf_379], [4, 4, 1]);
        addComputePass(device, commandEncoder, pipelines[423], layouts[423], infinityBuf, [buf_379, buf_459], [2, 8, 1]);
        addComputePass(device, commandEncoder, pipelines[424], layouts[424], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[425], layouts[425], infinityBuf, [buf_379, buf_459], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[426], layouts[426], infinityBuf, [buf_459, buf_379], [16, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[427], layouts[427], infinityBuf, [buf_379, buf_459], [32, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[428], layouts[428], infinityBuf, [buf_459, buf_379], [64, 1, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[431], layouts[431], infinityBuf, [buf_587, buf_586], [25, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[432], layouts[432], infinityBuf, [buf_588, buf_584, buf_587, buf_487], [75, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[433], layouts[433], infinityBuf, [buf_589, buf_588], [25, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[434], layouts[434], infinityBuf, [buf_590, buf_588, buf_589], [75, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[435], layouts[435], infinityBuf, [output0, buf_588, buf_590], [75, 1, 1]);
